...
Version  : 0.6.28
Release  : 52
URL      : https://cran.r-project.org/src/contrib/miscTools_0.6-28.tar.gz
Source0  : https://cran.r-project.org/src/contrib/miscTools_0.6-28.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1683147609
